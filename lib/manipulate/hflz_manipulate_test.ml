...
let%expect_test "to_abs" =
  ...
  [%expect {|
    (Hflz.Abs (
       { Id.name = "x_3"; id = 31; ty = (Type.TySigma (Type.TyBool ())) },
       (Hflz.Abs ({ Id.name = "x_2"; id = 32; ty = Type.TyInt },
          (Hflz.Abs ({ Id.name = "x_1"; id = 33; ty = Type.TyInt },
             (Hflz.Bool true)))
          ))
       )) |}]
...
let%expect_test "extract_abstraction" =
  ...
  [%expect {|
    a_sub3435 x_33
    a_sub3435 =ν λx_33:int.λx_11:int.λx_22:bool.x_44 (x_11 + x_22 * x_33) |}]
      ...
      ∀x_100100.
       ∀x_300300.
        ...
        || x_100100 < 10 || x_100100 < 1 * x_33 || x_100100 < 1 * x_55
           || x_100100 < (-1) * x_33
           || x_100100 < (-1) * x_55
        || Exists36 x_33 x_44 x_55 x_11 x_22 x_100100 x_300300 |}];
          ...
          λx_300300:int.
           ((λx_11:int.
            ...
            || (λx_11:int.
                ...
                x_11 x_22
            || Exists36 x_33 x_44 x_55 x_11 x_22 (x_100100 - 1) x_300300
            || Exists36 x_33 x_44 x_55 x_11 x_22 x_100100 (x_300300 - 1))
